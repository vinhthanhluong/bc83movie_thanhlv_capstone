export default function Alert({ color, text }) {
  return (
    <div className="fixed z-21 top-0 inset-x-0 max-w-[280px] mx-auto transition-all duration-300">
      <div
        id="alert-border-1"
        className={`flex items-center p-4 mb-4 text-${color}-800 border-t-4 border-${color}-300 bg-${color}-50`}
        role="alert"
      >
        <svg
