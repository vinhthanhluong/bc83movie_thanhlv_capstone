  ...
  return (
    <nav className="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
      <div className="max-w-[1536px] flex flex-wrap items-center justify-between mx-auto p-4">
        <Link to="/" className="flex items-center space-x-1.5 lg:space-x-3 rtl:space-x-reverse">
          <img
        ...
        <div className="flex items-center lg:order-2 space-x-2 lg:space-x-0 rtl:space-x-reverse">
          <div className="flex items-center">
            ...
            <span className="mx-1 lg:mx-2 hidden md:block">/</span>
            <Link
              to="/register"
              className="hidden md:flex items-center font-medium text-sm  cursor-pointer transition-all hover:text-[var(--mainColor)] hover:underline"
            >
              Đăng ký
            </Link>
          </div>
          ...
          <button
            ...
            type="button"
            className="inline-flex items-center  w-8 h-8 justify-center text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100  dark:text-gray-400 dark:hover:bg-gray-700 "
