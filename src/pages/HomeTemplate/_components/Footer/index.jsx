...
export default function Footer() {
  ...
  useEffect(() => {
      const handleScrollToTop = () =>{
        setShowToTop(window.scrollY > 10)
      }
  ...
  return (
    <>
      <footer>
        <div className="footer-top order-2 bg-[#2c2c2c] py-8 px-5 md:order-2">
          <div className="max-w-screen-xl mx-auto flex flex-col justify-between gap-4  items-start md:gap-5 md:flex-row ">
            <div className="relative w-full md:w-auto">
              <Link
                to="/"
                className="flex mx-auto w-fit items-center mb-3 md:mx-0"
              >
                <img
            ...
            <div className="flex justify-center w-full md:w-auto">
              <a
                href="#"
                className="text-white hover:text-[var(--mainColor)] dark:hover:text-white"
              >
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
              ...
              <a
                href="#"
                className="text-white hover:text-[var(--mainColor)] dark:hover:text-white ms-5"
              >
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
      ...
      {showToTop && (
        <div
          className="totop flex items-center justify-center w-12 h-12 fixed bottom-4 right-4 z-10 border border-gray-300 rounded-full bg-white text-black cursor-pointer transition-all duration-300 hover:bg-[var(--mainColor)] hover:text-white hover:border-[var(--mainColor)]"
