      ...
      <div className="md:grid grid-cols-7 w-full max-w-7xl mx-auto">
        <div className="mx-auto w-full py-4 text-sm border-[#E7E4E6] mt-7 border col-span-4 rounded-lg">
          <div className="px-4">
            ...
            {/* Ngày */}
            <div className="flex gap-2 overflow-x-auto mb-4 border-[#E7E4E6] border-b pb-5">
              {dates.map((date, idx) => (
                <button
                  key={idx}
                  className={`cursor-pointer bg-[#111827] min-w-[50px] px-2 py-2 border rounded-lg text-center ${
                    idx === 0 ? "bg-pink-600 text-white" : "hover:bg-pink-400"
                  }`}
                >
                ...
                <div>
                  ...
                  <div class="pt-4">
                    ...
                    <div class="flex flex-wrap gap-3">
                      <button class="px-4 py-2 border border-blue-500 text-black rounded hover:bg-blue-50 transition">
                        13:00 ~ 14:50
                      </button>
                      <button class="px-4 py-2 border border-blue-500 text-black rounded hover:bg-blue-50 transition">
                        13:40 ~ 15:30
                      ...
                      <button class="px-4 py-2 border border-blue-500 text-blue-600 rounded hover:bg-blue-50 transition">
                        19:00 ~ 20:50
                      </button>
                    </div>
                  </div>
